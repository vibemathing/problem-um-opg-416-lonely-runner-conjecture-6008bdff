...
```json
{
  ...
  "attempts": [
    {
      "artifacts": [],
      "attempt_id": "attempt:um-opg-416-lonely-runner-conjecture-6008bdff-source-fidelity-01",
      "claims": [],
      "completed_at": null,
      "generator": "trusted-rolling-source-admission-v1",
      "inputs": [
        "problem-library/records/canonical-problems.jsonl",
        "https://www.unsolvedmath.com/problems/OPG-416"
      ],
      "lifecycle": "planned",
      "method": "discovery",
      "objective": "Close the source-fidelity obligation before attempting the frozen root statement.",
      "obligation_graph_id": "graph:um-opg-416-lonely-runner-conjecture-6008bdff-v1",
      "problem_contract_sha256": "98d5f8c720e6df661fea7df398491eb5cd33560709969cfe9754332220f7c5c2",
      "problem_id": "problem:um-opg-416-lonely-runner-conjecture-6008bdff",
      "route_id": "route:um-opg-416-lonely-runner-conjecture-6008bdff-source-fidelity",
  ...
  "obligation_graphs": [
    {
      "attempt_id": "attempt:um-opg-416-lonely-runner-conjecture-6008bdff-source-fidelity-01",
      "graph_id": "graph:um-opg-416-lonely-runner-conjecture-6008bdff-v1",
      "obligations": [
        {
          "dependencies": [
            "obligation:um-opg-416-lonely-runner-conjecture-6008bdff-statement-fidelity"
          ],
          "kind": "root_claim",
          "obligation_id": "obligation:um-opg-416-lonely-runner-conjecture-6008bdff-root",
          "statement": {
            "formal_declaration": null,
            "language": "en",
            "text": "Conjecture Suppose $k$ runners having distinct constant speeds start at a common point and run laps on a circular track with circumference 1. Then for any given runner, there is a time at which that runner is distance at least $\\frac{1}{k}$ (along the track) away from every other runner."
          },
          "statement_sha256": "1405fdcc8a3b4fc9a5e670d8d4ef667141b8aa26be7fb29292f32292a3730330"
        },
        {
          "dependencies": [],
          "kind": "definition",
          "obligation_id": "obligation:um-opg-416-lonely-runner-conjecture-6008bdff-statement-fidelity",
          "statement": {
            "formal_declaration": null,
            "language": "en",
      ...
      "root_obligation_id": "obligation:um-opg-416-lonely-runner-conjecture-6008bdff-root",
      "route_id": "route:um-opg-416-lonely-runner-conjecture-6008bdff-source-fidelity"
    }
  ],
  "problem_contract": {
    ...
    "sources": [
      {
        ...
        "source_record_id": "unsolvedmath-opg-416-8aea63386793",
        "url": "https://www.unsolvedmath.com/problems/OPG-416"
      },
      {
        "retrieved_at": "2026-09-02T00:06:43Z",
